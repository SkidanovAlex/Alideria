...
class RiddleGenerator
{
	...
	function generate_C( )
	{
		...
		$moo[2] = Array( "Осина", "Дуб", "Рябина", "Тополь", "Береза", "Липа", "Сосна" );
	...
	function generate_A( )
	{
		...
		$items[4][1] = Array ( "свитка", "кристалла", "эликсира", "оберега" );
...
if( false ) /*тут можно поменять значение на true чтобы потестировать скрипт, обращаясь к нему напрямую.*/
{
