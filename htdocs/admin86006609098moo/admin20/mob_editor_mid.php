...
else
{
	...
	if(strlen($arr[avatar]) > 0)
		print("<td valign=top><img src='../images/avatars/$arr[avatar]'></td>");

	print ("<td valign=top>При создании моба для леса  охраняемая глубина обозначает следующее:<br>" );
