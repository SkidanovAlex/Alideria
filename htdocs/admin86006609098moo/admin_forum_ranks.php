...
$forum_room_names = Array( 22 => "Чисто для крутанов конкретных", 21 => "The TOP SECRET project IDE!", 0 => "Новости от Творцов", 1 => "Ошибки Игры", 2 => "Опросы от Администрации", 3 => "Общие Вопросы", 4 => "Прохождение Квестов", 5 => "Идеи и Предложения", 6 => "Персонажи", 7 => "Свободное Общение", 8 => "Творчество Игроков", 10 => "Объявления - продажа", 9 => "Объявления - покупка", 11 => "Жалобная книга", 19 => "Закрытый разрел модераторов чата", 20 => "Закрытый разрел модераторов" );
