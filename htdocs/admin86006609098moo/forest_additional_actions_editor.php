...
while( $arr = f_MFetch( $res ) )
{
	...
	$tc += $chance;
	echo "<a href=phrase_editor.php?id=$arr[phrase_id]&from=$frm>$arr[text]</a> [$chance%] (<a href='http://www.alideria.ru/admin86006609098moo/forest_additional_actions_editor.php?id=$id&ddel=$arr[phrase_id]'>[X]</a>)<br>";
}
