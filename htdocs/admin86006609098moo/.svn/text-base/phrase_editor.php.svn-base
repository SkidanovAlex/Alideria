...
if( isset( $HTTP_POST_VARS[effect_id] ) )
{
	...
	f_MQuery( "INSERT INTO phrase_effects ( phrase_id, effect_id, image, description, duration, effect ) VALUES ( $id, $_POST[effect_id], '$_POST[effect_image]', '$_POST[effect_descr]', $duration, '$_POST[effect_effect]' )" );
...
print( "Дает экспы: <input type=text name=expr value='$arr[gain_exp]'> (отрицательное значение, если экспа должна быть снята)" );
...
print( "<img width=11 height=11 style='cursor:pointer' onclick=\"expand_pe('effects')\" id=ieffects src='../images/e_plus.gif'>&nbsp;<b>Эффекты</b><br><div id=deffects style='display:none'>" );
...
print( "<tr><td> Длительность, мин: </td><td><input type=text name=effect_duration class=m_btn></td></tr>" );
...
print( "<img width=11 height=11 style='cursor:pointer' onclick=\"expand_pe('quests')\" id=iquests src='../images/e_plus.gif'>&nbsp;<b>Квесты</b><br><div id=dquests style='display:none'>" );
