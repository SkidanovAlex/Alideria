...
if( array_key_exists('nm', $_POST) &&  isset( $_POST['nm'] ) )
{
	...
	if( $arr )
	{
		if( $pid < 3 && $player->SpendMoney( 500 ) || $pid >= 3 && $player->SpendUMoney( 1 ) )
		{
			...
			echo "<b>Подарок персонажу {$plr->login} успешно доставлен</b><br><li><a href=game.php>Подарить еще один подарок</a><li><a href=game.php?phrase=1191>Уйти</a>";
			return;
...
echo "<li><a href=game.php?phrase=1191>Уйти</a>";
echo "<table><tr><td>";
