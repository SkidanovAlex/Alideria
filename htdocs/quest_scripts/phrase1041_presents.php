...
*/
		if( $curre == 0 && $player->SpendMoney( $price ) || $curre == -1 && $player->SpendUMoney( $price ) )
		{
			...
			echo "<b>Подарок персонажу {$plr->login} успешно доставлен</b><br><li><a href=game.php>Подарить еще один подарок</a><li><a href=game.php?phrase=2216>Уйти</a>";
...
echo "<i>Международный Женский День пришел в Теллу. В этот день принято дарить цветы и игрушки прекрасным и любимым девушкам. Ведь их красота спасает мир! По случаю праздника Шамаханский торговец опять поставил свой лазурный шатер на берегу Лидеры. Благоухающие подарки можно приобрести в самой известной праздничной лавке Теллы.</i><br><br><b>Шамаханский торговец: </b>Оу-у-у, щьто же ти стоишь на проходе, заходи, канэщна! Вот сматри, сколько всего интересного есть у меня, вибирай, покупай, не скупись, вай-вай-вай!<br><br>";
echo "<li style=\"list-style-image: URL('images/dots/dot-exit.gif')\"><a href=game.php?phrase=2216>*Покинуть шатер Шамаханского торговца*</a><br><br>";
echo "<table><tr><td>";
