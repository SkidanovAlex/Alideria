...
<center><table><tr><td colspan=3><script>FLUl();</script><div style='position:relative;top:0px;left:0px;overflow:hidden;width:256px;height:256px;'><img id=rh width=384 height=256 src='lab_img.php' style='position:absolute;left:-64px;top:0px;z-index:1;'><img id=rh2 style='position:absolute;left:0px;top:0px;z-index:2;' src=empty.gif></div><script>FLL();</script></td><td><div style='position:relative;top:0px;left:0px;overflow:hidden;width:256px;height:256px;'>
...
function do_go( )
{
	...
	furl = "lab_img.php?rnd="+Math.random();
...
function query_left( )
{
	query( 'lab_do.php?do=left', 'a' );
}

function query_right( )
{
	query( 'lab_do.php?do=right', 'a' );
}

function query_go( )
{
	query( 'lab_do.php?do=go', 'a' );
}

function query_leave( )
{
	query( 'lab_do.php?do=leave', 'a' );
}
...
function refr( )
{
	document.getElementById( id1 ).src='lab_img.php?rnd='+Math.random();
}
