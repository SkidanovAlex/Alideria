...
$inner_food = array(
	array( "Салат из Водорослей", array( 111=>1, 112=>1, 113=>1 ), 6, 250, 14259 ),
	array( "Пирог с Медом", array( 97 => 18 ), 6, 450, 14262 ),
	array( "Жаркое из Рыбы", array( 106 => 16, 107 => 10, 108 => 8 ), 4, 1000, 14263 )

);

$food_types = Array(
	Array( "Жареный Карась", Array( 106 => 7 ), 7 ),
	Array( "Уха из Карпа", Array( 107 => 5 ), 10 ),
	Array( "Щука на Углях", Array( 108 => 5 ), 15 ),
	Array( "Заливное из Сома", Array( 109 => 5 ), 25 ),
	Array( "Варёные Раки", Array( 75853 => 2 ), 40 ),
	Array( "Черепаховый Суп", Array( 75854 => 2 ), 60 )
);

$item_names = Array(
	106 => "Карась", 107 => "Карп", 108 => "Щука", 109 => "Сом", 75853 => "Рак", 75854 => "Черепаха"
);
$item_images = Array(
	106 => "res/karas.gif", 107 => "res/carp.gif", 108 => "res/shuka.gif", 109 => "res/som.gif", 75853 => "res/crayfish.png", 75854 => "res/tortoise.png"
);
...
else
{
	...
	if( 0 != ( getPlayerPermitions( $clan_id, $player->player_id ) & $CAN_COOK ) )
	{
        ...
        foreach( $food_types as $id=>$arr )
        {
        	...
        	echo "<br /><br /><i>Также можно мгновенно приготовить большие порции:</i><br /><br /> Из <b>100</b> штук за <b>2 <img src='/images/umoney.gif' /></b> <a href='/game.php?order=cafe&cook=$id&fast=1'>(&gt;&gt;&gt;)</a><br />Из <b>1000</b> штук за <b>10 <img src='/images/umoney.gif' /></b> <a href='game.php?order=cafe&cook=$id&fast=2'>(&gt;&gt;&gt;)</a>";
