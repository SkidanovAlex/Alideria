...
<script language="javascript" src="js/capital_q7.js" type="text/javascript"></script>
<?
if( $noob )
{
?>
...
<img id="LocationImage" src="images/locations/w/capital.jpg" width=700 height=320 border=0>
<img style='position:absolute; left:448px; top:178px; width:235px; height:142px;' src='images/misc/q7/BP.png'>
</div></td></tr>
<map name="Map">
