...
<script language="javascript" src="js/capital_with_traider8m.js" type="text/javascript"></script>
<?
if( $noob )
{
?>
...
<img id="LocationImage" src="images/locations/capitalWithTraider.jpg" width=700 height=320 border=0>
<img style='position:absolute; left:487px; top:150px; width:150px; height:170px;' src='images/locations/traider.png' />
</div></td></tr>
<map name="Map">
