...
else
{
	if( isset( $_GET['bet'] ) )
	{
		...
		if( $_GET['bet'] < 0 || $_GET['bet'] > 7 ) die( );
		$stavkas = Array( 20, 50, 100, 500, 1000, 2500, 5000, 10000 );
...
else
{
	...
	echo "<button onclick='location.href=\"game.php?bet=5\"' class=ss_btn style='width:120px;'>2500 дублонов</button>&nbsp;";
	echo "<button onclick='location.href=\"game.php?bet=6\"' class=ss_btn style='width:120px;'>5000 дублонов</button>&nbsp;";
	echo "<button onclick='location.href=\"game.php?bet=7\"' class=ss_btn style='width:120px;'>10000 дублонов</button>&nbsp;";
}
