...
function isRecipients( )
{
	...
	if( target.indexOf( ',' ) != -1 )
	{
		document.getElementById( 'recipients' ).innerHTML = 'Адресаты:';
		document.getElementById( 'targetInfo' ).style.display = 'none';
	}
	else
	{
		document.getElementById( 'recipients' ).innerHTML = 'Адресат:';
...
<div id="letter_text">
	<table>
		...
		<tr>
			<td>&nbsp;</td>
			<td>
				<button id="send_btn" class="s_btn" onclick="send_letter( );">Отправить</button>
			</td>
		</tr>
	</table>
</div>
