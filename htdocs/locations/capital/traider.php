...
if( array_key_exists( 'nm', $_POST ) &&  isset( $_POST['nm'] ) )
{
	...
	if( $arr && $dura >= 0 && $dura < 4 )
	{
		...
		if( $dura == 0 ) { $duration = 2; $price = 9000; $curre = 0; }
		if( $dura == 1 ) { $duration = 7; $price = 27000; $curre = 0; }
		if( $dura == 2 ) { $duration = 31; $price = 6; $curre = -1; }
		if( $dura == 3 ) { $duration = 100; $price = 30; $curre = -1; }
...
function dchange( id )
{
	...
	if( dur == 0 ) { val = 9000; cur = 'money.gif'; }
	else if( dur == 1 ) { val = 27000; cur = 'money.gif'; }
	else if( dur == 2 ) { val = 6; cur = 'umoney.gif'; }
	else if( dur == 3 ) { val = 30; cur = 'umoney.gif'; }
