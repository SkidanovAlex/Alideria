 ...
 */
?>
Начисляет указанное число суток выбранного премиума всем игрокам.<br />
WARNING! Пока в разработке! Ничего не трогать во избежании "№(;"(№;"№;"№; и конца света.<br />
<table celspacing="0" cellpadding="1">
	<tbody>
		...
		<tr>
			...
			<td>
				<input type="text" id="presentDeadline" value="2147483647" />
