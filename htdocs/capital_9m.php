...
<div id='arena_9m' style='z-index:200;display:none;position:absolute;left:100px;top:55px;'>
<table cellspacing=0 cellpadding=0 style='width:202px;height:109px;' background='images/misc/9m/cell.png'><tr><td width=93>&nbsp;</td>
<td width=109>
<small><b><? echo $player->login ?>!!<br>
Нужна твоя помощь!<br>
На Теллу напали Шамахане!<br>
<br>
</b></small><a href=game.php?talk=11>К Дракону!</a>
</td></tr></table>
</div>
...
function show_arena_9m()
{
	_( 'arena_9m' ).style.display = '';
}

<?
if( !$player->HasTrigger( 245 ) )
{
?>
selectArray["Sel3"][6] = 'javascript:show_arena_9m()';
<?
}
?>
