...
function getPrivateRoom( a )
{
	...
	if( a == 'Duncan' )
	{
		msgs[n][0] ='Уважаемый игрок, ты открыл приват Главы модерации Алидерии. Я не приветствую мультоводство, багоюз и автоматизацию игры. Но всегда готов помочь очистить совесть и проконсультировать по правилам Алидерии.<br><li>Если ты хочешь пожаловаться на другого игрока либо модератора, тебе сюда: <a target="_blank" href="http://www.alideria.ru/forum.php?room=11">Жалобная книга</a><br><li>Если ты хочешь сообщить об ошибке, опечатке, тебе сюда: <a target="_blank" href="http://www.alideria.ru/forum.php?room=1">Ошибки Игры</a><br><li>Если ты хочешь предложить нововведение в игре, тебе сюда: <a target="_blank" href="http://www.alideria.ru/forum.php?room=5">Идеи и Предложения</a>';
		msgn[n] = 1;
	}
	if( a == 'Торговый' )
	{
