var empties = new Array( 'bg50hlm', 'bg50amt', 'bg50wpn', 'bg50wpn', 'bg25brc', 'bg25brc', 'bg25rng', 'bg25rng', 'bg50arm', 'bg50clk', 'bg50glv', 'bg50bts', 'bg25empty', 'bg25empty', 'bg25empty', 'bg25empty', 'bg25empty', 'bg25empty', 'bg25empty', 'bg25empty', 'bg25empty', 'bg25empty', 'bg25empty', 'bg25empty' );
...
var xs = new Array( 50, 137,   6, 180,  10,  35,  60,  85,   8, 188,  20, 138,  18,  72,  126,  180,  18,  72,  126,  180,  18,  72,  126,  180,  18,  72,  126,  180 );
var ys = new Array(  8,   8,  57,  46, 255, 255, 255, 255, 129, 118, 195, 263, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18 );
var ws = new Array( 50, 50, 50,  50,  25, 25, 25, 25, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50 );
