...
function clog(arr)
{
	...
	if( arr[0] == 8 )
	{
		...
		if( arr[4] == 1 ) ret += " критическим ударом!!!";
		if( arr[4] == 2 ) ret += " ТРОЙНЫМ критическим ударом!!!";
		return ret;
	}
	...
	if( arr[0] == 32 ) return "<b>" + arr[1] + "</b> колдует заклинание " + arr[2] + ". <b>" + arr[1] + "</b> колдует заклинание " + arr[2] + " еще раз!!! <b>" + arr[1] + "</b> колдует заклинание " + arr[2] + " ЕЩЕ РАЗ!!!!!";
}
