...
<script language="javascript" src="/js/capitalsummer.js" type="text/javascript"></script>
<?
if( $noob )
{
?>
...
<img id="LocationImage" src="images/locations/capital.jpg" width=700 height=320 border=0></div></td></tr>
<map name="Map">
...
?>
	...
	{
	?>
	<area shape="poly"coords="548,199,584,222,540,222,516,245,490,319,612,319,647,285,621,274,601,192" onmousemove="SelShow(event,'Sel18');" onmouseout="SelHide('Sel18');" onclick="LocClick('Sel18');" style='cursor:pointer'>
	<?
	}
	?>	
</map>
...
<?
	...
	if( $noob )
	{
		echo "<a href=# onclick=\"alert( '$be_noob' );\">Перейти в текстовый режим</a>";
	}
	else
	{
		echo "<a href=game.php?text_mode>Перейти в текстовый режим</a>";
	}
?>
