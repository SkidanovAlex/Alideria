...
function get_finish_text( $item_id, $num, $str, $str1, $str2 )
{
	...
	if( $item_id == 41 )
	{
		return "К сожалению, Вы ничего не поймали. Но, что это?!!! Вы с удивлением обнаруживаете <a href=help.php?id=1010&item_id=$item_id target=_blank><b>аквамарин</b></a> ($num) Вознеся хвалу Святому Рандому, Вы решаете ловить исключительно в данном месте реки";
	}
	...
	if( mt_rand( 1, 20 ) == 1 )
	{
		...
		return "Наконец-то клюет! На сей раз Вы выловили $str. Хорош улов, теперь будет что рассказать своим друзьям-рыбакам. Нужно обязательно снять мерку с неё. А вот как раз и небольшая палочка, пожалуй, стоит её взять себе для мерки. Вы находите <a href=help.php?id=1010&item_id=36 target=_blank><b>дерево</b></a>";
	}
